  ...
  return (
    <div className="absolute inset-0 flex" style={{ background: '#030608' }}>
      ...
      <div className="flex-shrink-0 flex flex-col justify-center px-10"
        style={{ width: 320, background: 'rgba(229,9,20,0.03)', borderRight: '1px solid rgba(229,9,20,0.08)' }}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-xs px-2.5 py-0.5 rounded-full font-bold uppercase"
                      style={{ background: 'rgba(229,9,20,0.1)', color: '#38bdf8', border: '1px solid rgba(229,9,20,0.2)' }}>
                      {pl.type}
                    </span>
                  </div>
