...
export default function SportsScreen({ onNavigate }: Props) {
  return (
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        <div className="mt-8 flex flex-col gap-3 w-full">
          {['Live Fixtures & Scores', 'Live Score Overlay', 'Sports Categories', 'Channel Shortcuts'].map((feat) => (
            <div key={feat} className="flex items-center gap-3 p-3.5 rounded-xl" style={{ background: '#12161e', border: '1px solid #1e2838' }}>
